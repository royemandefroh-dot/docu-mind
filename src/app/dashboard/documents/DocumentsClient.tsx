...
export function DocumentsClient({ documents: initialDocs, storageUsage: initialStorageUsage, projects }: DocumentsClientProps) {
                                                ...
                                                <div className="flex flex-col items-center justify-center py-24 text-center">
                                                    ...
                                                    {!searchQuery &&
                                                        activeView === "workspace" && (
                                                            <Link href="/dashboard">
                                                                <Button className="flex items-center gap-2 px-6 py-6 text-sm font-medium shadow-lg shadow-primary/25 transition-all hover:scale-[1.02] active:scale-95">
                                                                    <Upload className="h-4 w-4" />
                                                                    Upload Document
                                                                </Button>
                                                            </Link>
